        ...
        if (!session) {
            try {
                ...
                if (!session) {
                    ...
                    if (latestIncident) {
                        // 🔍 Debug: Log the actual incident structure
                        console.log(`📋 Found incident structure:`, JSON.stringify(latestIncident, null, 2));
                        ...
                        console.log(`📋 Using latest incident: ${incidentId} (Priority: ${priority})`);
